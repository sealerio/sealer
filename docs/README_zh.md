...
```shell script
#安装sealer
wget https://github.com/alibaba/sealer/releases/download/v0.3.1/sealer-v0.3.1-linux-amd64.tar.gz && \
tar zxvf sealer-v0.3.1-linux-amd64.tar.gz && mv sealer /usr/bin
#运行集群
