...
wget https://github.com/alibaba/sealer/releases/download/v0.5.1/sealer-v0.5.1-linux-amd64.tar.gz && \
tar zxvf sealer-v0.5.1-linux-amd64.tar.gz && mv sealer /usr/bin
