...
* registry.cn-qingdao.aliyuncs.com/sealer-apps/ingress-nginx-controller:v0.48.1
* registry.cn-qingdao.aliyuncs.com/sealer-apps/ceph:v16.2.5
...
if you want to apply a cloud image which need persist storage. we provide openebs as cloud storage backend. OpenEBS
...
## use it as base image to build another useful image

For example, use helm image to build a mysql CloudImage:
...
Build mysql CloudImage:

```shell
sealer build -t registry.cn-qingdao.aliyuncs.com/sealer-apps/mysql:8.8.5 .
```
