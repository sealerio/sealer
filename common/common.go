...
const (
	...
	RemoteCmdCopyStatic           = "cp -r -f %s %s"
	KubeControllerConf            = "/etc/kubernetes/controller-manager.conf"
	KubeSchedulerConf             = "/etc/kubernetes/scheduler.conf"
	KubeKubeletConf               = "/etc/kubernetes/kubelet.conf"
	KubePki                       = "/etc/kubernetes/pki"
