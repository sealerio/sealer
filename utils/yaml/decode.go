...
//cluster api version
const (
	ClusterV1 = "zlink.aliyun.com/v1alpha1"
	ClusterV2 = "sealer.cloud/v2"
)

var decodeCRDFuncMap = map[string]func(reader io.Reader) (interface{}, error){
	Cluster:                decodeClusterFunc,
	Config:                 decodeConfigListFunc,
	Plugin:                 decodePluginListFunc,
	InitConfiguration:      decodeInitConfigurationFunc,
	JoinConfiguration:      decodeJoinConfigurationFunc,
	ClusterConfiguration:   decodeClusterConfigurationFunc,
	KubeletConfiguration:   decodeKubeletConfigurationFunc,
	KubeProxyConfiguration: decodeKubeProxyConfigurationFunc,
}

// decode CRD from file
...
func DecodeV1ClusterFromFile(filepath string) (*v1.Cluster, error) {
	...
	cluster, err := decodeCRDFromReader(NewK8sYamlDecoder(file), Cluster, func(version string) interface{} { return &v1.Cluster{} })
...
func decodeClusterFunc(reader io.Reader) (out interface{}, err error) {
	...
	out, err = decodeCRDFromReader(NewK8sYamlDecoder(reader), Cluster, switchVersion)
	if err != nil {
		return nil, err
	}
	//Compatible with v1
...
func decodeConfigListFunc(reader io.Reader) (interface{}, error) {
	...
	for {
		in, err := decodeCRDFromReader(decoder, Config, switchVersion)
		if err != nil {
			if err == io.EOF {
				return configs, nil
			}
...
func decodePluginListFunc(reader io.Reader) (interface{}, error) {
	...
	for {
		in, err := decodeCRDFromReader(decoder, Plugin, switchVersion)
		if err != nil {
			if err == io.EOF {
				return plugins, nil
			}
...
func decodeInitConfigurationFunc(reader io.Reader) (out interface{}, err error) {
	...
	return decodeCRDFromReader(NewK8sYamlDecoder(reader), InitConfiguration, switchVersion)
}
...
func decodeJoinConfigurationFunc(reader io.Reader) (out interface{}, err error) {
	...
	return decodeCRDFromReader(NewK8sYamlDecoder(reader), JoinConfiguration, switchVersion)
}
...
func decodeClusterConfigurationFunc(reader io.Reader) (out interface{}, err error) {
	...
	return decodeCRDFromReader(NewK8sYamlDecoder(reader), ClusterConfiguration, switchVersion)
}
...
func decodeKubeletConfigurationFunc(reader io.Reader) (out interface{}, err error) {
	...
	return decodeCRDFromReader(NewK8sYamlDecoder(reader), KubeletConfiguration, switchVersion)
}
...
func decodeKubeProxyConfigurationFunc(reader io.Reader) (out interface{}, err error) {
	...
	return decodeCRDFromReader(NewK8sYamlDecoder(reader), KubeProxyConfiguration, switchVersion)
}
