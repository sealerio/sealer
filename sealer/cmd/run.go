...
var runCmd = &cobra.Command{
	...
	Long: `sealer run registry.cn-qingdao.aliyuncs.com/sealer/cloudrootfs:v1.16.9-alpha.7 --masters [arg] --nodes [arg]
examples:
create default cluster:
	sealer run registry.cn-qingdao.aliyuncs.com/sealer/cloudrootfs:v1.16.9-alpha.7

create cluster by cloud provider, just set the number of masters or nodes:
	sealer run registry.cn-qingdao.aliyuncs.com/sealer/cloudrootfs:v1.16.9-alpha.7 --masters 3 --nodes 3

create cluster to your baremetal server, appoint the iplist:
	sealer run registry.cn-qingdao.aliyuncs.com/sealer/cloudrootfs:v1.16.9-alpha.7 --masters 192.168.0.2,192.168.0.3,192.168.0.4 \
