...
func newLocalRegistryDriver(endpoint string, dataDir string, deployHosts []net.IP, infraDriver infradriver.InfraDriver, distributor imagedistributor.Distributor) Driver {
