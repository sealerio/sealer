...
// is reset to the condition it was in prior to the function being invoked.
// If Raw is true the terminal will be put into raw mode prior to calling the function.
