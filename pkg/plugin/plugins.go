...
func (c *PluginsProcessor) runOutOfTree(cluster *v2.Cluster, config v1.Plugin, phase Phase) error {
...
func (c *PluginsProcessor) runInTree(cluster *v2.Cluster, config v1.Plugin, phase Phase) error {
	var p Interface
